...
G =
{
    ...
    activearea = {left = -2800, right = 1000, bottom = 100, top = 700}, -- 英雄/怪物活动的范围
}
...
ActorCommonValues =  -- 英雄/怪物常见属性，用于英雄/怪物初始化
{
